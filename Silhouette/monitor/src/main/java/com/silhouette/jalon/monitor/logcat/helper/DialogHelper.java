package com.silhouette.jalon.monitor.logcat.helper;
...
import com.silhouette.jalon.monitor.logcat.R;
import com.silhouette.jalon.monitor.logcat.data.FilterQueryWithLevel;
...
import com.silhouette.jalon.monitor.logcat.util.Callback;
...
public class DialogHelper {
    ...
    public static void startRecordingWithProgressDialog(final String filename, final String filterQuery,
                                                        final String logLevel, final Runnable onPostExecute, final Context context) {
